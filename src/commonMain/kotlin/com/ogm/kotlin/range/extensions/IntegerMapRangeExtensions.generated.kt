 ...
 * @see [Iterable.map]
 */
fun <T : Comparable<T>> OpenEndRange<T>.mapToShortOpenEndRangeRange(block: (T) -> Short): ShortRange =
 ...
 * @see [Iterable.map]
 */
fun <T : Comparable<T>> OpenEndRange<T>.mapToUShortOpenEndRangeRange(block: (T) -> UShort): UShortRange =
 ...
 * @see [Iterable.map]
 */
fun <T : Comparable<T>> OpenEndRange<T>.mapToByteOpenEndRangeRange(block: (T) -> Byte): ByteRange =
 ...
 * @see [Iterable.map]
 */
fun <T : Comparable<T>> OpenEndRange<T>.mapToUByteOpenEndRangeRange(block: (T) -> UByte): UByteRange =
