 ...
 * @see [Iterable.map]
 */
fun <T : Comparable<T>> OpenEndRange<T>.mapToDoubleOpenEndRange(block: (T) -> Double): OpenEndRange<Double> =
 ...
 * @see [Iterable.map]
 */
fun <T : Comparable<T>> OpenEndRange<T>.mapToFloatOpenEndRange(block: (T) -> Float): OpenEndRange<Float> =
	block(start)..<block(endExclusive)
