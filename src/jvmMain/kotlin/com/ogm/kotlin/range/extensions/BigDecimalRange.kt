...
data class BigDecimalRange(
...
) : ClosedRange<BigDecimal>, Iterable<BigDecimal> {
	...
	override fun contains(value: BigDecimal): Boolean =
		start <= value && if (open) endInclusive > value else endInclusive >= value
