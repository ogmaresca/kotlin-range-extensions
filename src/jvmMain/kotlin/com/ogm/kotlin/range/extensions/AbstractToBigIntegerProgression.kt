...
abstract class AbstractToBigIntegerProgression<T : Comparable<T>, TStep : Comparable<TStep>> protected constructor(
	start: T,
	endInclusive: T,
	step: TStep,
	bigIntegerStep: BigInteger,
	zeroStep: TStep,
	private val converter: AbstractToBigIntegerProgressionConverter<T>,
	...
	open inner class ToBigIntegerProgressionIterator(
		private val bigIntegerIterator: BigIntegerProgression.BigIntegerProgressionIterator,
	) : Iterator<T> {
