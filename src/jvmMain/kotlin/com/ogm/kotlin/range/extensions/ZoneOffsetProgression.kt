...
class ZoneOffsetProgression private constructor(
	start: ZoneOffset,
	endInclusive: ZoneOffset,
	step: Int,
	...
	companion object {
		fun fromClosedRange(rangeStart: ZoneOffset, rangeEnd: ZoneOffset, step: Int) =
			ZoneOffsetProgression(rangeStart, rangeEnd, step)

		fun fromClosedRange(range: ClosedRange<ZoneOffset>, step: Int) =
