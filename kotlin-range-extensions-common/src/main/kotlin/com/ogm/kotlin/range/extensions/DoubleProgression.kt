...
open class DoubleProgression protected constructor(
	...
	override fun Double.plus(right: Double): Double = this + right

	override fun Double.minus(right: Double): Double = this - right

	override fun Double.rem(right: Double): Double = this % right
